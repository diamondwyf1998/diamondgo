...
# Fresh Dual-GPU 2x96, Score Komi 4.5, Margin Reward 0.2, 18-Hour Run
...
- purpose: long comparison run for the 2-layer architecture using current training tricks
- fresh_start: true
