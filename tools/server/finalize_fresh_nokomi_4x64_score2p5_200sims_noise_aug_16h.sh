...
TRAIN_PID="${1:?usage: finalize_fresh_nokomi_4x64_score2p5_200sims_noise_aug_16h.sh TRAIN_PID}"
TRAIN_OUT="artifacts/multiworker-9x9-fresh-nokomi-4x64-score2p5-200sims-noise-aug-16h-20260606"
EVAL_OUT="artifacts/eval-suite-fresh-nokomi-4x64-score2p5-200sims-train-100sims-eval-16h-20260606"
TACTICAL_OUT="artifacts/tactical-fresh-nokomi-4x64-score2p5-200sims-train-100sims-eval-16h-20260606"
...
mkdir -p "$TRAIN_OUT" "$EVAL_OUT" "$TACTICAL_OUT"
{
  ...
  echo "eval_note=standard 100-simulation eval for comparability; training self-play used 200 simulations"
} >> "$LOG"
