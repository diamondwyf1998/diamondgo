...
TRAIN_PID="${1:?usage: finalize_cont_dualgpu_2x96_score6p5_margin0p2_400sims_7d_after18hplus3h.sh TRAIN_PID}"
TRAIN_OUT="artifacts/multiworker-9x9-cont-dualgpu-2x96-score6p5-margin0p2-400sims-max150-7d-after18hplus3h-20260607"
EVAL_OUT="artifacts/eval-suite-cont-dualgpu-2x96-score6p5-margin0p2-400sims-train-100sims-eval-7d-after18hplus3h-20260607"
TACTICAL_OUT="artifacts/tactical-cont-dualgpu-2x96-score6p5-margin0p2-400sims-train-100sims-eval-7d-after18hplus3h-20260607"
...
mkdir -p "$TRAIN_OUT" "$EVAL_OUT" "$TACTICAL_OUT"
{
  ...
  echo "eval_note=standard 100-simulation eval after the 7d continuation; training self-play used 400 simulations"
