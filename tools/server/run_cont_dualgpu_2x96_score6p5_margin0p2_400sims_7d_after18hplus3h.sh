...
BASE_OUT="artifacts/multiworker-9x9-cont-dualgpu-2x96-score4p5-margin0p2-250sims-max150-3h-after18h-20260607"
...
# Continuation Dual-GPU 2x96, Score Komi 6.5, Margin Reward 0.2, 400 Sims, 7 Days
...
- purpose: long continuation from the 18h+3h 2x96 line, testing higher scoring komi and larger MCTS search
- fresh_start: false
...
- previous_segment_final_cycle: 272
