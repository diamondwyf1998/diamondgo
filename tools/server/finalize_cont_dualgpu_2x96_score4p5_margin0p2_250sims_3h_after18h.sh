...
TRAIN_PID="${1:?usage: finalize_cont_dualgpu_2x96_score4p5_margin0p2_250sims_3h_after18h.sh TRAIN_PID}"
TRAIN_OUT="artifacts/multiworker-9x9-cont-dualgpu-2x96-score4p5-margin0p2-250sims-max150-3h-after18h-20260607"
EVAL_OUT="artifacts/eval-suite-cont-dualgpu-2x96-score4p5-margin0p2-250sims-train-100sims-eval-3h-after18h-20260607"
TACTICAL_OUT="artifacts/tactical-cont-dualgpu-2x96-score4p5-margin0p2-250sims-train-100sims-eval-3h-after18h-20260607"
...
mkdir -p "$TRAIN_OUT" "$EVAL_OUT" "$TACTICAL_OUT"
{
  ...
  echo "eval_note=standard 100-simulation eval after the +3h continuation; training self-play used 250 simulations"
