...
TRAIN_PID="${1:?usage: finalize_cont_nokomi_4x64_score5p5_margin0p2_300sims_6h.sh TRAIN_PID}"
TRAIN_OUT="artifacts/multiworker-9x9-cont-nokomi-4x64-score5p5-margin0p2-300sims-max150-6h-20260606"
EVAL_OUT="artifacts/eval-suite-cont-nokomi-4x64-score5p5-margin0p2-300sims-train-100sims-eval-6h-20260606"
TACTICAL_OUT="artifacts/tactical-cont-nokomi-4x64-score5p5-margin0p2-300sims-train-100sims-eval-6h-20260606"
