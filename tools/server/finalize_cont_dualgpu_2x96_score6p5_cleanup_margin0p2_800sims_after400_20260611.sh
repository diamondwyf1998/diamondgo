...
TRAIN_PID="${1:?usage: finalize_cont_dualgpu_2x96_score6p5_cleanup_margin0p2_800sims_after400_20260611.sh TRAIN_PID}"
TRAIN_OUT="artifacts/multiworker-9x9-cont-dualgpu-2x96-score6p5-cleanup-margin0p2-800sims-max150-after400-20260611"
EVAL_OUT="artifacts/eval-suite-cont-dualgpu-2x96-score6p5-cleanup-margin0p2-800sims-train-100sims-eval-after400-20260611"
TACTICAL_OUT="artifacts/tactical-cont-dualgpu-2x96-score6p5-cleanup-margin0p2-800sims-train-100sims-eval-after400-20260611"
...
mkdir -p "$TRAIN_OUT" "$EVAL_OUT" "$TACTICAL_OUT"
{
  ...
  echo "eval_note=standard 100-simulation eval after the cleanup-enabled 800-simulation continuation; training self-play used 800 simulations after the 400-sim segment"
