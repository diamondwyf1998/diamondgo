...
TRAIN_PID="${1:?usage: finalize_scorekomi25_1h.sh TRAIN_PID}"
TRAIN_OUT="artifacts/multiworker-9x9-resume0p5-score2p5-100sims-120moves-1h-20260605"
EVAL_OUT="artifacts/eval-suite-resume0p5-score2p5-100sims-120moves-1h-20260605"
TACTICAL_OUT="artifacts/tactical-resume0p5-score2p5-100sims-120moves-1h-20260605"
