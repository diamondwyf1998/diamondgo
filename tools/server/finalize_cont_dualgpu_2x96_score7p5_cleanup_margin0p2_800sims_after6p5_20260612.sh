...
TRAIN_PID="${1:?usage: finalize_cont_dualgpu_2x96_score7p5_cleanup_margin0p2_800sims_after6p5_20260612.sh TRAIN_PID}"
TRAIN_OUT="artifacts/multiworker-9x9-cont-dualgpu-2x96-score7p5-cleanup-margin0p2-800sims-max150-after6p5-20260612"
EVAL_OUT="artifacts/eval-suite-cont-dualgpu-2x96-score7p5-cleanup-margin0p2-800sims-train-100sims-eval-after6p5-20260612"
TACTICAL_OUT="artifacts/tactical-cont-dualgpu-2x96-score7p5-cleanup-margin0p2-800sims-train-100sims-eval-after6p5-20260612"
...
mkdir -p "$TRAIN_OUT" "$EVAL_OUT" "$TACTICAL_OUT"
{
  ...
  echo "eval_note=standard 100-simulation eval after the score7.5 cleanup-enabled 800-simulation continuation"
