...
TRAIN_PID="${1:?usage: finalize_fresh_nokomi_4x64_score6p5_200sims_noise_aug_5h.sh TRAIN_PID}"
TRAIN_OUT="artifacts/multiworker-9x9-fresh-nokomi-4x64-score6p5-200sims-noise-aug-5h-20260606"
EVAL_OUT="artifacts/eval-suite-fresh-nokomi-4x64-score6p5-200sims-train-100sims-eval-5h-20260606"
TACTICAL_OUT="artifacts/tactical-fresh-nokomi-4x64-score6p5-200sims-train-100sims-eval-5h-20260606"
