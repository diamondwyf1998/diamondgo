...
TRAIN_PID="${1:?usage: finalize_fresh_dualgpu_2x96_score5p5_margin0p2_300sims_6h.sh TRAIN_PID}"
TRAIN_OUT="artifacts/multiworker-9x9-fresh-dualgpu-2x96-score5p5-margin0p2-300sims-max150-6h-20260606"
EVAL_OUT="artifacts/eval-suite-fresh-dualgpu-2x96-score5p5-margin0p2-300sims-train-100sims-eval-6h-20260606"
TACTICAL_OUT="artifacts/tactical-fresh-dualgpu-2x96-score5p5-margin0p2-300sims-train-100sims-eval-6h-20260606"
...
mkdir -p "$TRAIN_OUT" "$EVAL_OUT" "$TACTICAL_OUT"
{
  ...
  echo "eval_note=standard 100-simulation eval for comparability; training self-play used 300 simulations"
} >> "$LOG"
