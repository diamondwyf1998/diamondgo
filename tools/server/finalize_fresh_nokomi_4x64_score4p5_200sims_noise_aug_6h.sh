...
TRAIN_PID="${1:?usage: finalize_fresh_nokomi_4x64_score4p5_200sims_noise_aug_6h.sh TRAIN_PID}"
TRAIN_OUT="artifacts/multiworker-9x9-fresh-nokomi-4x64-score4p5-200sims-noise-aug-6h-20260606"
EVAL_OUT="artifacts/eval-suite-fresh-nokomi-4x64-score4p5-200sims-train-100sims-eval-6h-20260606"
TACTICAL_OUT="artifacts/tactical-fresh-nokomi-4x64-score4p5-200sims-train-100sims-eval-6h-20260606"
