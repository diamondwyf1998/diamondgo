...
PREVIOUS_OUT="${PREVIOUS_OUT:-artifacts/multiworker-13x13-cont-dualgpu-4x64-history2-autokomi-start8p5-ladder10p5-minpass120-lr0p0015-cleanup-finalboard-margin0p2-1000sims-max250-temp0p6-moves30-mid0p3-until100-late0p2-32w-after-temp0p7-20260627-2026-temp0p6-restart1-after-oom-cleanup}"
...
# 13x13 final-board continuation: 1600 self-play simulations
...
- purpose: continue the active 13x13 final-board-head line while increasing self-play MCTS from 1000 to 1600 simulations
