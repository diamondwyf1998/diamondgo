...
BASE_OUT="artifacts/multiworker-9x9-cont-dualgpu-2x96-score6p5-cleanup-margin0p2-400sims-max150-7d-after18hplus3h-20260607"
RESUME_CHECKPOINT="${RESUME_CHECKPOINT:-$BASE_OUT/latest.pt}"
TRAIN_OUT="artifacts/multiworker-9x9-cont-dualgpu-2x96-score6p5-cleanup-margin0p2-800sims-max150-after400-20260611"
...
# Continuation Dual-GPU 2x96, Score Komi 6.5, Cleanup, Margin Reward 0.2, 800 Sims, After 400-Sim Segment
...
- purpose: double self-play MCTS from 400 to 800 simulations while preserving the current score6.5 cleanup experiment
- fresh_start: false
...
- comparison_warning: this continuation changes only the self-play search budget from 400 to 800 simulations; compare later cycles by positions/games/wall-clock and record the transition point
...
- old scripts/checkpoints: preserved; the 400-sim run is stopped and retained, this continuation uses a new output directory
NOTES
